...
const BaseOffer = t.interface({
  ...
  collectionId: t.maybe(t.list(r.Maxlength(50)(t.String)))
...
const Collection = t.interface({
  // attributes
  collectionId: r.Maxlength(50)(t.String),
  name: t.maybe(r.Maxlength(512)(t.String)),
  url: t.maybe(r.Maxlength(512)(r.Absoluteurl)),
  picture: t.maybe(r.Maxlength(10)(t.list(r.Maxlength(512)(t.refinement(r.Absoluteurl, (p) =>
    r.Imagepath.is(p), 'Absoluteurl with Imagepath'
  ))))),
  description: t.maybe(r.Maxlength(3000)(t.String))
...
const Collections = t.list(Collection, 'Collection')
